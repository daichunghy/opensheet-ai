...
## [v0.1.0-alpha.3](https://github.com/daichunghy/opensheet-ai/releases/tag/v0.1.0-alpha.3) — 2026-08-23
...
## [v0.1.0-alpha.2](https://github.com/daichunghy/opensheet-ai/releases/tag/v0.1.0-alpha.2) — 2026-08-23

Current public source alpha. The GitHub tag is verified by npm ci and npm run verify from a clean clone. The npm package is prepared but registry publication is pending npm OTP verification. The release claims only deterministic plans, policy gates, receipts, in-memory execution, and a greenfield XLSX adapter; external integration and adoption remain unproven.
